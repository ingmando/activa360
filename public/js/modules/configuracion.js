...
export async function renderSettings(user){
  ...
  return `<div class="page-head"><div><div class="eyebrow">Administración</div><h1>Configuración</h1><p>Parámetros generales, respaldo remoto y herramientas administrativas del MVP Cloud.</p></div><span class="badge presentation-badge">Activa 360 v1.2 Cloud</span></div>
