...
export async function renderTwelveMeetingDetail(id,user){
  ...
  <section class="twelve-summary-groups" aria-label="Resumen de la reunión">
    <article class="twelve-summary-group"><div class="twelve-summary-group-title">Estado semanal</div><div class="twelve-summary-pair"><div class="twelve-mini-metric"><span>Reportes completos</span><strong>${completed}/${rows.length}</strong><small>Hábitos diligenciados</small></div><div class="twelve-mini-metric"><span>Cumplimiento de hábitos</span><strong>${habitTotal?Math.round(habitYes/habitTotal*100):0}%</strong><small>Devocional, diezmo, ofrenda y altar</small></div></div></article>
    <article class="twelve-summary-group"><div class="twelve-summary-group-title">Impacto ministerial</div><div class="twelve-summary-pair"><div class="twelve-mini-metric"><span>Células realizadas</span><strong>${done}/${cells}</strong><small>Calculado desde Células</small></div><div class="twelve-mini-metric"><span>Para Encuentro 180°</span><strong>${enc}</strong><small>Inscripciones reportadas</small></div></div></article>
  </section>
